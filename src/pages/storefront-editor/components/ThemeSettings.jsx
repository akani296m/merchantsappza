...
const FOOTER_VARIANTS = [
    { value: 'columns', label: 'Columns', desc: 'Full with link columns' },
    { value: 'simple', label: 'Simple', desc: 'Single row layout' },
    { value: 'minimal', label: 'Minimal', desc: 'Copyright only' },
];
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <SettingsSection title="Layout" icon={Layout}>
                    ...
                    <div className="border-t border-gray-100 pt-4">
                        <VariantSelector
                            label="Footer Style"
                            value={getThemeValue('layout.footerVariant')}
                            onChange={(val) => updateSetting('layout.footerVariant', val)}
